...
public class MainLayoutController implements Initializable {
    ...
    private void switchAccount() {
    	try {
			...
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/AccountDetails.fxml"));
    ...
    private void switchCart() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/Cart.fxml"));
            Parent view = loader.load();
	...
	public void loadFXML(String FXML) {
		try {
			Parent view = FXMLLoader.load(ResourceUtil.getFxml(FXML));
			mainLayout.setCenter(view);
	...
	private void switchSupport() {
	    try {
	        FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/UserChat.fxml"));
